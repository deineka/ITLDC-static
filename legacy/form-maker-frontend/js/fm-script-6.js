    ...
    var labels_and_ids6 = {"2":"type_name","3":"type_submitter_mail","4":"type_own_select","5":"type_textarea","7":"type_file_upload","6":"type_recaptcha","1":"type_submit_reset"};
    var check_regExp_all6 = [];
    var check_paypal_price_min_max6 = [];
    var file_upload_check6 = {"7":"jpg, jpeg, png, gif, bmp, tif, tiff, svg, pdf, txt, log, doc, docx, csv, xls, xlsx, pps, ppt, pptx, xml, mp3, mp4, wma, wav, mpg, wmv"};
    var spinner_check6 = [];
 ...
 function after_submit6() {
	...
	function ajax_similarity6( obj, changing_field_id ) {
		jQuery.ajax({
			type: "POST",
			url: 'https://itldc.com/wp-admin/admin-ajax.php?action=fm_reload_input&page=form_maker',
			dataType: "json",
			data: {
				form_id: 6,
				inputs: obj.inputs
