/* https://itldc.com/wp-includes/js/comment-reply.min.js */
try{
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.easing.1.3.js */
try{
...
/* https://itldc.com/wp-includes/js/hoverIntent.min.js */
try{
...
/* https://itldc.com/wp-content/themes/hostmev2/js/superfish.min.js */
try{
/*
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.jplayer.min.js */
try{
/*
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.preloadify.min.js */
try{
// JavaScript Document
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.prettyPhoto.js */
try{
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.fitvids.js */
try{
/*!
* FitVids 1.0
*
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.sticky.js */
try{
...
/* https://itldc.com/wp-content/themes/hostmev2/js/jquery.appear.js */
try{
...
/* https://itldc.com/wp-content/themes/hostmev2/js/sys_custom.js */
try{
(function($){"use strict";jQuery(document).ready(function($){$(".minithumb, .gallery, .grid, .gallery-item, .postimg, .lightbox, .bio").preloadify({force_icon:"true",mode:"sequence"});$("a[data-rel^='prettyPhoto']").prettyPhoto({theme:'pp_default'});$('.footer-branches').hide();$(".at-footer-branches").on('click',function(e){e.preventDefault();$(this).toggleClass('at-toggleOpen');$(".footer-branches").slideToggle(500);$('html, body').animate({scrollTop:$(document).height()},500)});$('.atpsocials li').hover(function(){$(this).find('span.ttip').fadeIn()},function(){$(this).find('span.ttip').fadeOut()});$('.plan_box').hover(function(){$(".plan_info",this).stop().animate({top:'-430'},{queue:!1,duration:300})},function(){$(".plan_info",this).stop().animate({top:'0'},{queue:!1,duration:300})});$("span.close").click(function(){$(this).hide();$(this).parent().parent().animate({opacity:'0'}).slideUp(400)});$('.video-frame, .boxcontent, .video-stage, .video, .wp-video').fitVids();$("#back-top").hide();$(window).scroll(function(){if($(this).scrollTop()>100){$('#back-top').fadeIn()}else{$('#back-top').fadeOut()}});$('#back-top a').click(function(){$('body,html').animate({scrollTop:0},800);return!1});jQuery('.select_wrapper').each(function(){jQuery(this).prepend('<span>'+jQuery(this).find('.select option:selected').text()+'</span>')});jQuery('.select').on('change',function(){jQuery(this).prev('span').replaceWith('<span>'+jQuery(this).find('option:selected').text()+'</span>')});if($.isFunction($.fn.flexslider)){jQuery(".flexslider").flexslider({animation:flexslider_args.slideeffect,controlsContainer:".flex-container",slideshow:!0,slideshowSpeed:flexslider_args.slidespeed,animationSpeed:1200,directionNav:flexslider_args.slidednav,controlNav:!1,mousewheel:!1,smoothHeight:!1,prevText:" ",nextText:" ",start:function(slider){jQuery(".total-slides").text(slider.count);jQuery(".flex-active-slide").find(".flex-caption").addClass("flex-caption-anim")},before:function(slider){jQuery(slider).find(".flex-active-slide").each(function(){jQuery(".flex-active-slide").find(".flex-caption").removeClass("flex-caption-anim")})},after:function(slider){jQuery(".flex-active-slide").find(".flex-caption").addClass("flex-caption-anim")}})}
...
jQuery('.iva_tabNav a').on('click',function(event){var $anchorid=jQuery(this);jQuery(".iva_tabsWrap ul li").removeClass("current");jQuery(this).parent('li').addClass("current");jQuery('html, body').stop().animate({scrollTop:jQuery($anchorid.attr('href')).offset().top-tabs_NavPosition},500,'easeInOutExpo');event.preventDefault()});if($('#fixedheader').length){$(".iva_tabsWrap").sticky({topSpacing:fixedHeader})}else{if($wpAdminBar.length){$(".iva_tabsWrap").sticky({topSpacing:$wpAdminBar.height()})}else{$(".iva_tabsWrap").sticky({topSpacing:0})}}});jQuery('.iva_anim:not(.animated)').waypoint(function(){var animatedclass=jQuery(this).attr('data-id');jQuery(this).addClass('animate');jQuery(this).addClass('animated  '+animatedclass+'')},{offset:'85%'});var $wpAdminBar=jQuery('#wpadminbar');console.log($wpAdminBar);if($wpAdminBar.length){jQuery("#trigger").css('top',$wpAdminBar.height());jQuery("#trigger").toggle(function(){jQuery(this).animate({top:$wpAdminBar.height()},50).addClass("active")},function(){jQuery(this).animate({top:$wpAdminBar.height()},50).removeClass("active")})}else{jQuery("#trigger").toggle(function(){jQuery(this).animate({top:0},50).addClass("active")},function(){jQuery(this).animate({top:0},50).removeClass("active")})}
jQuery("#atp_menu").superfish({cssArrows:!1});systoggle();buttondata();accordion();progressbar();tabs();hoverimage()})})();function systoggle(){jQuery(".toggle-title").click(function(){jQuery(this).next(".toggle_content").slideToggle({duration:200})});jQuery(".toggle-title").toggle(function(){jQuery(this).addClass("active")},function(){jQuery(this).removeClass("active")});jQuery("#trigger").click(function(){jQuery(this).next("#sticky").slideToggle({duration:300,easing:'easeOutQuart'})})}
function buttondata(){jQuery(".btn").hover(function(){var $hoverBg=jQuery(this).attr('btn-hoverBg');var $hoverColor=jQuery(this).attr('btn-hoverColor');var $borderhoverColor=jQuery(this).attr('btn-hoverborder');if($hoverBg!==undefined){jQuery(this).css('background-color',$hoverBg)}else{}
...
jQuery("a[data-rel^='prettyPhoto']").contents("img").hover(function(){jQuery(this).stop().animate({"opacity":"0.3"},200);jQuery("span[class^=hover]").stop().animate({"opacity":"1"})},function(){jQuery(this).stop().animate({"opacity":"1"},200);jQuery("span[class^=hover]").stop().animate({"opacity":"0"})})})}
...
var classie={hasClass:hasClass,addClass:addClass,removeClass:removeClass,toggleClass:toggleClass,has:hasClass,add:addClass,remove:removeClass,toggle:toggleClass};if(typeof define==='function'&&define.amd){define(classie)}else{window.classie=classie}})(window);jQuery(window).load(function($){setTimeout(function(){if(jQuery(window).width()>900){if(jQuery('#boxed').length>0){$width=jQuery('#boxed').width()}else{$width=jQuery('html').width()}
...
/* https://itldc.com/wp-includes/js/wp-embed.min.js */
try{
...
/* https://itldc.com/wp-includes/js/jquery/ui/widget.min.js */
try{
/*!
...
if(jQuery(this).attr('class')=="faqwd_question_title_container"&&expand=="no"){expand="yes"}});if(collapse=="yes"){$(el).closest('.faqwd_conteiner ').find('.faqwd_collapse').show()}else{$(el).closest('.faqwd_conteiner ').find('.faqwd_collapse').hide()}
if(expand=="yes"){$(el).closest('.faqwd_conteiner ').find('.faqwd_expand').show()}else{$(el).closest('.faqwd_conteiner ').find('.faqwd_expand').hide()}
...
function faqwd_pagination(){var _this=this;this.$container=null;this.$pagination_container=null;this.$questions_container=null;this.faqwd_current_page=1;this.faqwd_max_page_num=10;this.search_view=!1;this.init=function($container){this.$container=$container;this.$pagination_container=$container.find('.faqwd_pagination');this.get_max_page_num();this.addButtons();this.to_page(1);this.add_buttons_events()};this.get_max_page_num=function(){if(this.search_view==!1){this.$container.find('.faqwd_cat').each(function(){var $this=jQuery(this);if($this.is(":visible")===!0){_this.$questions_container=$this;_this.faqwd_max_page_num=$this.find('.faqwd_question_li').length/faqwd.pagination_items_count}})}else{$this=this.$container.find('.faqwd_questions');_this.$questions_container=$this;_this.faqwd_max_page_num=$this.find('.faqwd_question_li.faqwd_search_visible').length/faqwd.pagination_items_count}};this.to_page=function(page_num){this.faqwd_current_page=page_num;page_num=parseInt(page_num);var start_index=(page_num-1)*faqwd.pagination_items_count;var end_index=(page_num*faqwd.pagination_items_count)-1;if(this.search_view==!1){var questions_elements=this.$questions_container.find(".faqwd_question_li")}else{var questions_elements=this.$questions_container.find(".faqwd_question_li.faqwd_search_visible")}
...
return search_data};this.restor_faq=function(){jQuery('.faqwd_categories_li:first').click();if(this.is_search_view==!1){return}
